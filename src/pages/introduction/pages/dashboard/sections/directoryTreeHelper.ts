            ...
            children: [
              {
                ...
                itemId: 'app###',
                label: 'Bu dizin içerisinde yer alan klasör ve dosyalar, ikonlar ile alakalıdır.',
              },
            ],
          },
          {
        ...
        children: [
          {
            ...
            closeIcon: null,
            itemId: 'usersdb',
            label: 'Bu dizin içerisindeki klasör ve dosyalar tamamen uygulama tanıtımı ile alakalıdır.',
          },
        ],
      },
      {
