...
const EditOrder: React.FC<EditOrderProps> = ({ data, open, setOpen, formSubmit }) => {
  ...
  return (
    <BootstrapDialog maxWidth="sm" fullWidth open={open} onClose={() => setOpen(false)}>
      <form onSubmit={handleSubmit(formHandleSubmit)}>
        <BootstrapDialogTitle onClose={() => setOpen(false)}>introduction.orderUpdate</BootstrapDialogTitle>
