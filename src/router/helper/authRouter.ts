...
export const AUTH_ROUTER_ITEMS: AuthRouterItems = {
  ...
  FORGOT_PASSWORD: {
    ...
    parentKey: 'AUTH_ROUTER_WRAPPER',
    key: 'FORGOT_PASSWORD',
    label: 'routes.forgotPasswordPage',
  ...
  RESET_PASSWORD: {
    ...
    parentKey: 'AUTH_ROUTER_WRAPPER',
    key: 'RESET_PASSWORD',
    label: 'routes.resetPasswordPage',
    path: '/reset-password',
    icon: UpdateIcon,
  },
};
